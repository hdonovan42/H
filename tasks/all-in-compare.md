...
- [x] G. Shipped 2026-07-16: commit 6b55ccc pushed, worker version c519c8e1 deployed, live smoke
      ...
      Resend DONE same day: send.hjd.ai verified (wizard → CF DNS, eu-west-1), send-only key in
      RESEND_API_KEY_ENV, production sign-in email confirmed accepted (Resend message id returned)
