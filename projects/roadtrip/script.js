// Global variables
        ...
        async function getRouteSegment(fromWaypoint, toWaypoint) {
            try {
                ...
                const maxRatio = straightLineDistance < 50 ? 2.0 : 2.0; //need to fix this line - 2.0 twice
        ...
        // Calculate route for all segments
        async function calculateRoute() {
            ...
            console.log('Route calculation complete:', routeSegments);
        }
        ...
        function handleDrop(e) {
            ...
            if (draggedItem !== this) {
                ...
                // Clear route data to force recalculation
                routeSegments = [];
                totalStats = { distance: 0, duration: 0 };
                updateUI();
            }
