...
PROB_TH = 0.81        # digest ELIGIBILITY bar — 26-REAL scale (v0.8.7, 2026-06-11 afternoon):
                      # live archive n=8,163 p80 0.843 / p95 0.867 / max 0.914; reals 0.821-0.914.
                      # Set just BELOW the weakest real view (#2145, 0.821 — slid to a 0.001
                      # margin over the old 0.82 bar, so dropped a notch) rather than at p80 —
...
ALERT_TH = 0.92       # instant-alert bar (26-real scale): above ALL 8,163 known FPs (max 0.914,
