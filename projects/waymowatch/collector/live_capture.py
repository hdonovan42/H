...
PROB_TH = 0.82        # digest ELIGIBILITY bar — 20-REAL scale (v0.8.4, 2026-06-11 morning):
                      # live archive n=7,364 p80 0.841 / p95 0.866 / max 0.913; reals 0.829-0.915.
                      # Set just BELOW the weakest real view (#2145, 0.829) rather than at p80 —
...
ALERT_TH = 0.92       # instant-alert bar (20-real scale): above ALL 7,364 known FPs (max 0.913;
                      # 16 FPs sat >=0.90, none >=0.92). Top real re-scores 0.915 — alerts are the
